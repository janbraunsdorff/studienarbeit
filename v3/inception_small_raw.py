...
class InceptionRaw(nn.Module):
    def __init__(self):
        super(InceptionRaw, self).__init__()
        # input
        ...
        # Block A
        self.Mixed_5b = IncA(192, pool_features=32)
        self.Mixed_5c = IncA(256, pool_features=64)
        ...
        # Block E
        self.Mixed_7b = IncE(1280)
        self.Mixed_7c = IncE(2048)
