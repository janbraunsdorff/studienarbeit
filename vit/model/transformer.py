...
class Transformer(nn.Module):
    def __init__(self, patch_size):
        ...
        self.norm_1 = nn.BatchNorm1d(num_features=conf.patch_size*conf.patch_size, eps=1e-6)
        self.norm_2 = nn.BatchNorm1d(num_features=conf.patch_size*conf.patch_size, eps=1e-1)
